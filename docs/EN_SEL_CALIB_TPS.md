Select Throttle Position Sensor Calibration/*
...
- Click the ‘Learn’ button next to the TPS 0%
                      reading (see below).![tpscalibration_sel](../images/Eugene/SEL_EN_TPSCalib.png)
...
- Verify that the ‘Current TPS’ reading reflects the
                    ...
                    times to check its operation).Note: If you are using a TPS switch this
